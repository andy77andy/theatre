...
urlpatterns = [
    ...
    path("actors/update/", ActorUpdateView.as_view(), name="actor-update"),
    ...
    path("directors/update/", DirectorUpdateView.as_view(), name="director-update"),
    ...
    path("genres/update/", GenreUpdateView.as_view(), name="genre-update"),
    ...
    path("plays/update/", PlayUpdateView.as_view(), name="play-update"),
    ...
    path("awards/update/", AwardUpdateView.as_view(), name="award-update"),
